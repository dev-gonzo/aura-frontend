...
import { LojaAbandonedCartsPage } from './pages/loja-abandoned-carts/loja-abandoned-carts.page';
import { LojaContactPage } from './pages/loja-contact/loja-contact.page';
...
export const LOJA_ROUTES: Routes = [
  ...
  },
  {
    path: 'loja/contato',
    canActivate: [adminGuard],
    component: LojaContactPage,
  },
  {
    path: 'loja/carrinhos-abandonados',
    canActivate: [adminGuard],
    component: LojaAbandonedCartsPage,
  },
  {
    path: 'loja/produtos',
    canActivate: [adminGuard],
